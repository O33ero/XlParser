...
if __name__ == "__main__":
    ...
    # Сегодня я узнал о The Dot. Я в шоке, ничего круче я еще не видел.
    # Если что, сейчас 1:36 12.09.2021. У меня нет слов. Это просто нечто.
    # Я не знаю как описать мое удивление. Если бы я знал, что люди долбанутые
    # настолько, что готовы добавить VS Code как секретную фичу github, я бы
    # никогда не полез в IT индустрию. Всем спасибо, теперь я буду рассказывать
    # об этом каждый день. Извините, но это просто....
